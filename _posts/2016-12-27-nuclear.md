...
In terms of mass, how much more energy dense is nuclear fuel at a burnup of 50 GW-days/ton than gasoline (use gasoline's higher heating value)? Note that this question is about real nuclear power plants and is different from the comparison David made in the first video involving the energy released from an individual fission or fusion (so you'll actually need to do a calculation).
