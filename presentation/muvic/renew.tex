...
%   Option can be added in \documentclass{???}
%	Theme			::	newPxFont
%	Options			::	progressbar
%					::	sectionpages
%					::	numfooter
...
% I just add UVic color theme support. Now the color is based on UVicNavy.
% Another UVic ECON color theme suuport is based on ECON blended green. 
% All new color definition can be found in beamercolorthemesthlm.sty style file.   
